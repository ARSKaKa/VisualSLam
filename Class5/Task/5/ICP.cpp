// COPY FROM eglrp :https://github.com/eglrp/VSLAM_Homework
...
int main(int argc, char **argv) {
    ...
    vector<Sophus::SE3d, Eigen::aligned_allocator<Sophus::SE3d>> poses1;
    ...
    while(getline(trajectory, sLine) && !sLine.empty()){
        ...
        T1 = Sophus::SE3d(q1, t1);
        poses1.push_back(T1);
        position1.push_back(t1);
        T2 = Sophus::SE3d(q2, t2);
        poses2.push_back(T2);
    ...
    Sophus::SE3d SE3_update(R, t);           // 从R,t构造SE(3)
